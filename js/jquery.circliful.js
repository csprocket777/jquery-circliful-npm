  ...
  $.fn.circliful = function (options, callback) {
    ...
    return this.each(function () {
      ...
      if (settings.targetPercent > 0) {
        ...
        elements += '<circle cx="100" cy="100" r="69" fill="none" stroke="' + settings.targetColor + '" stroke-width="3" stroke-dasharray="' + (2 * Math.PI * 69) + '" stroke-dashoffset="' + ((2 * Math.PI * 69) * (1 - (settings.targetPercent / 100))) + '" transform="rotate(-90,100,100)" />';
      }
